ServerEvents.recipes((event) => {
  ...
  const itemsToRemove_byid = [
    'clavis:lock_pick',
    'forbidden_arcanus:ritual/tyr_boots',
    'forbidden_arcanus:ritual/tyr_leggings',
    'forbidden_arcanus:ritual/tyr_chestplate',
    'forbidden_arcanus:ritual/tyr_helmet',
    'forbidden_arcanus:ritual/draco_arcanus_boots',
    'forbidden_arcanus:ritual/draco_arcanus_leggings',
    'forbidden_arcanus:ritual/draco_arcanus_chestplate',
    'forbidden_arcanus:ritual/draco_arcanus_helmet',
    'mynethersdelight:cutting/skoglin_trophy',
    'mynethersdelight:cutting/cutting/hoglin_hide',
